...
## Key Concepts
- **Skills** follow the [AgentSkills.io](https://agentskills.io) spec — agent-agnostic, not Codex-specific
...
- All skill content is agent-agnostic. Never assume Codex/OpenAI/etc.
