...
<style>
	...
	.header-left { flex: 1; }
	.skill-category { font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: var(--accent); margin-bottom: 0.5rem; display: inline-block; }
	...
	.btn-use:hover { background: var(--accent-bright); transform: translateY(-1px); box-shadow: 0 6px 24px rgba(108,92,231,0.4); }
	...
	.author-card:hover { border-color: var(--accent); box-shadow: var(--card-shadow-hover); }
	.author-avatar {
	...
	.verified { display: inline-flex; align-items: center; justify-content: center; width: 18px; height: 18px; border-radius: 50%; background: var(--accent); color: white; font-size: 0.6rem; font-weight: 700; margin-left: 0.3rem; vertical-align: middle; }
	...
	.file-tab:hover { color: var(--text-primary); background: rgba(108,92,231,0.05); }
	.file-tab.active { color: var(--accent-bright); border-bottom-color: var(--accent); }
	...
	.code-header { display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1.25rem; border-bottom: 1px solid var(--border); background: rgba(108,92,231,0.03); }
	...
	.code-copy:hover { border-color: var(--accent); color: var(--accent-bright); }
	.code-content { padding: 1.5rem; font-family: var(--font-mono); font-size: 0.82rem; line-height: 1.5; color: var(--text-secondary); overflow-x: auto; margin: 0; tab-size: 2; white-space: pre-wrap; word-wrap: break-word; overflow-wrap: break-word; }
